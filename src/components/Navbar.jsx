...
function Navbar() {
  ...
  return (
    <>
      ...
      <aside
        ref={menuRef}
        className={`fixed right-0 top-0 bottom-0 z-50 w-[min(19rem,88vw)] nav-shell md:hidden transition-transform duration-300 ease-out ${open ? "translate-x-0" : "translate-x-full pointer-events-none"}`}
        aria-hidden={!open}
      >
