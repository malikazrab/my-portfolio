...
import { CheckCircle2, Github, Loader2, Mail, MapPin, Phone, Send } from "lucide-react";
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <ScrollReveal direction="up" className="glass-card spotlight-card rounded-xl p-5">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                Open to freelance projects, contract work, and full-time opportunities. Typical response time: <strong className="text-cyan-300">under 24 hours</strong>.
              </p>
            </ScrollReveal>
          </div>
