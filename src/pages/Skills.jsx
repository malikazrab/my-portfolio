  ...
  return (
    <main className="page-section pt-28">
      <div className="container-tight">
        ...
        >
          <h3 className="font-display font-bold text-xl dark:text-white mb-6 text-center">Tools & Ecosystem</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            ...
            <motion.div
              ...
              className="glass-card rounded-xl p-5 text-center hover:-translate-y-1 transition-transform duration-200"
            >
